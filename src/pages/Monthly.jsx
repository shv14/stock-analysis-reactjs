...
// const Monthly = () => {
//     return (
//         <div className="monthly-page p-4 min-h-screen flex flex-col items-center justify-center bg-cover bg-center">
//             <h2 className="text-center text-3xl font-bold mb-4">Monthly Stock Prices</h2>
...
// src/pages/Monthly.js
// // import React from 'react';
// // import monthlyImage from '../images/monthly.jpg';
// // import '../App.css';

// // const Monthly = () => {
// //     return (
// //         <div className="monthly-page min-h-screen bg-cover bg-center p-4" style={{ backgroundImage: `url(${monthlyImage})` }}>
// //             <h1 className="text-center text-4xl font-bold mb-8 text-white">Monthly Stock Prices</h1>
...
import monthlyImage from '../images/monthly.jpg'; // Import your background image here
...
const Monthly = () => {
    ...
    const fetchData = async () => {
        ...
        setError('');
        try {
            const response = await fetch(`https://www.alphavantage.co/query?function=TIME_SERIES_MONTHLY&symbol=${symbol}&apikey=demo`);
            const result = await response.json();
            if (result['Monthly Time Series']) {
                setData(result['Monthly Time Series']);
            } else {
    ...
    return (
        <div className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: `url(${monthlyImage})` }}>
            <div className="absolute inset-0 bg-black bg-opacity-50 p-8">
            <h1 className=" flex text-3xl md:text-5xl font-bold m-5">Monthly <p className="mx-1" style={{color: 'cyan'}}>Stock</p> Data</h1>
